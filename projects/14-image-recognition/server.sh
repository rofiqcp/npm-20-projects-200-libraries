...
show_menu() {
    echo ""
    echo "╔════════════════════════════════════════╗"
    echo "║   AI Image Recognition - Server Management"
    echo "╚════════════════════════════════════════╝"
    echo ""
    echo "1. Start"
    echo "2. Stop"
...
show_status() {
    [ -f "$ENV_FILE" ] && source "$ENV_FILE"
    BACKEND_PORT="${BACKEND_PORT:-5000}"; FRONTEND_PORT="${FRONTEND_PORT:-3000}"
    echo ""; echo "📊 AI Image Recognition Status:"; echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
edit_ports() {
    [ -f "$ENV_FILE" ] && source "$ENV_FILE"
    BACKEND_PORT="${BACKEND_PORT:-5000}"; FRONTEND_PORT="${FRONTEND_PORT:-3000}"
    echo ""; echo "⚙️  Edit Ports - AI Image Recognition"; echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    cat > "$ENV_FILE" <<EOF
# AI Image Recognition - Port Configuration
