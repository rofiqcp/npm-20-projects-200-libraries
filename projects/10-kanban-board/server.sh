...
show_status() {
    [ -f "$ENV_FILE" ] && source "$ENV_FILE"
    BACKEND_PORT="${BACKEND_PORT:-5000}"; FRONTEND_PORT="${FRONTEND_PORT:-3000}"
    echo ""; echo "📊 Kanban Board Status:"; echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    pgrep -x mongod &>/dev/null && echo "  ✅ MongoDB: RUNNING" || echo "  ❌ MongoDB: STOPPED"
    echo ""; echo "🌐 Access:"; echo "  Frontend: http://localhost:$FRONTEND_PORT"; echo "  Backend:  http://localhost:$BACKEND_PORT"; echo ""
}

edit_ports() {
    [ -f "$ENV_FILE" ] && source "$ENV_FILE"
    BACKEND_PORT="${BACKEND_PORT:-5000}"; FRONTEND_PORT="${FRONTEND_PORT:-3000}"
    echo ""; echo "⚙️  Edit Ports - Kanban Board"; echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    cat > "$ENV_FILE" <<EOF
# Kanban Board - Port Configuration
